  ...
  return (
    <div className='flex justify-start w-full pl-8 pt-5'>
      <div className='flex flex-col items-center justify-evenly w-[220px] h-[120px] p-3 text-sm border border-gray-400'>
        ...
        <Link to="/envio" className='text-blue-500'>Envio</Link>
      </div>
      ...
      <div className='flex flex-col items-center justify-evenly w-[220px] h-[120px] p-3 text-sm border border-gray-400'>
        ...
        <Link to={"/pasarela-pago"} className='text-blue-500'>Pasarela Pago</Link>
      </div>
      ...
      <div className='flex flex-col items-center justify-evenly w-[220px] h-[120px] p-3 text-sm border border-gray-400'>
        ...
        <Link to={"/sucursal"} className='text-blue-500'>Sucursal</Link>
      </div>
